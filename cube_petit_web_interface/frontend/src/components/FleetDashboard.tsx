...
// 英字表記は使わずカタカナ読みで書く(LLMがこの文の表記をそのまま真似るため。
// 英字はjtalk TTSで正しく読めない)。バックエンド側の同名定数と同期を保つこと。
const DEFAULT_VENUE_CONTEXT =
  'ここはロスコンジェーピー2026(2026年8月4日・5日、茨城県つくば市の「つくばカピオ」)の会場です。' +
  ...
  'セリフは音声合成でそのまま読み上げられます。英字の固有名詞・略語は絶対に英字のまま書かず、' +
  '必ずカタカナの読みで書いてください(ロスコンジェーピー、ロスツー ジャジー、ライダー、エルエルエムのように)。';
