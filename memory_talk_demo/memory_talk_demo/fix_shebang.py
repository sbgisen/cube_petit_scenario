...
print(f'[fix_shebang] Updating shebangs in: {scripts_path}')
print(f'[fix_shebang] Using shebang: {shebang}')

if not scripts_path.exists():
    print(f'[fix_shebang] Skipped: {scripts_path} does not exist.')
    exit(0)
...
for file in scripts_path.iterdir():
    ...
    print(f'[fix_shebang] Fixed: {file.name}')
