...
def make_delta(d_curiosity=0.0, d_boredom=0.0, d_energy=0.0, d_silence_bias=0.0,
               weight=1.0, human_detected=False, petit_detected=False,
               sleep_request=False):
    return {
...
def make_values(curiosity=50.0, boredom=50.0, energy=50.0, silence_bias=50.0):
    return {
        'curiosity': curiosity,
        'boredom': boredom,
        'energy': energy,
...
class TestAggregateDeltas:
    ...
    def test_empty_deltas_returns_base_drift(self):
    ...
    def test_multiple_deltas_weighted_sum(self):
        deltas = [
...
class TestUpdateState:
    ...
    def test_awake_drift_direction(self):
    ...
    def test_enter_sleep_when_energy_drops(self):
    ...
    def test_wake_when_energy_recovered(self):
    ...
    def test_deltas_applied_and_clamped(self):
        values = make_values(curiosity=99.9, boredom=0.1, silence_bias=99.9)
        deltas = [make_delta(d_curiosity=10.0, d_boredom=-10.0,
                             d_silence_bias=10.0, weight=1.0)]
    ...
    def test_detection_flags_forwarded(self):
...
class TestPersistence:
    ...
    def test_default_state_file_path(self, tmp_path):
    ...
    def test_hostname_to_namespace(self):
